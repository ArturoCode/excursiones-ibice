    ...
    .then((res) => Promise.all([res[0].json(), res[1].json()]))
      .then((res) => {
        ...
        for(var excursion of data){          
            ...
            fichaTemp.querySelector("#url-excursion").href = `./detalles/?id=${excursion.id_excursion}`;
            fichaTemp.querySelector("#nombre-excursion").innerHTML = excursion.nombre_excursion;
            fichaTemp.querySelector("#nombre-excursion").href = `./detalles/?id=${excursion.id_excursion}`;
